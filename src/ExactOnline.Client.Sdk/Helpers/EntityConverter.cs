...
namespace ExactOnline.Client.Sdk.Helpers
{
    ...
    public class EntityConverter
    {
        ...
        public T ConvertJsonToObject<T>(string json)
        {
            ...
            {
                throw new IncorrectJsonException("InvalidJson", ex);
            }
        }
        ...
        public List<T> ConvertJsonArrayToObjectList<T>(string json)
        {
            ...
            {
                throw new IncorrectJsonException("An error occurred while processing the json string. Possibly the result is too big. Please make a more specific query.", ex);
            }
        }
